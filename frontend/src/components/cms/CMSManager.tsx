...
export default function CMSManager() {
  ...
  const [activeTab, setActiveTab] = useState<'pages' | 'blocks' | 'templates'>('pages');
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Manage pages, content blocks, and templates</p>
        </div>
        {activeTab === 'pages' && (
          <button
            onClick={() => {
      ...
      {activeTab === 'blocks' && <ContentBlockManager />}
      {activeTab === 'templates' && <PageTemplateManager />}
